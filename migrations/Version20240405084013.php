 ...
 */
final class Version20240405084013 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE label_has_artist (id INT AUTO_INCREMENT NOT NULL, left_at DATETIME NOT NULL, joined_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE label_has_artist_artist (label_has_artist_id INT NOT NULL, artist_id INT NOT NULL, INDEX IDX_D2A95AC3B7970CF8 (artist_id), INDEX IDX_D2A95AC35207E184 (label_has_artist_id), PRIMARY KEY(label_has_artist_id, artist_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE label_has_artist_label (label_has_artist_id INT NOT NULL, label_id INT NOT NULL, INDEX IDX_289FEF8F33B92F39 (label_id), INDEX IDX_289FEF8F5207E184 (label_has_artist_id), PRIMARY KEY(label_has_artist_id, label_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
