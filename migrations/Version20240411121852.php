 ...
 */
final class Version20240411121852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, user_id_user_id INT NOT NULL, fullname VARCHAR(90) NOT NULL, label VARCHAR(90) NOT NULL, active VARCHAR(90) NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_1599687DE94BC09 (user_id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE label_has_artist (id INT AUTO_INCREMENT NOT NULL, id_artist_id INT NOT NULL, id_label_id INT NOT NULL, id_label_has_artist VARCHAR(90) NOT NULL, joined_at DATETIME NOT NULL, left_at DATETIME DEFAULT NULL, INDEX IDX_FF9D48D937A2B0DF (id_artist_id), INDEX IDX_FF9D48D96362C3AC (id_label_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
